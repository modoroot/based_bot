...
client.on('messageCreate', (message) => {
	...
	if (random < 0.001) {
	  console.log(random)
	  message.reply('[temene temene hamaihepiu](https://cdn.discordapp.com/attachments/1247185053017178162/1278703542793670738/Ae5060WhLO399Y_k.mp4?ex=66d5b979&is=66d467f9&hm=c004d5a96c0dd289c366f077072d49a5ba3fbcbdbc22d3d21bf9f1e72b2e6bf0&)');
	}
});
