...
client.on('messageCreate', async message => {
	if (!message.content.match("ewa")) return;
	message.channel.send(`[temene](https://cdn.discordapp.com/attachments/287266770816073728/1279102623978487880/nnU6vxDFdZo94WFo.mp4?ex=66eb9c66&is=66ea4ae6&hm=ebb8ade6e8837c1ccc43b9b905cc2356b1bd2bde40acfc431d78c18dcf344d50&)`);
});
...
cron.schedule('0 6 * * *', () => {
    const channel = client.channels.cache.get('976807836661202987');
    if (channel) {
		channel.send(`[RUBEN P4 YAAAAAAAAAAAAAAAAAAAAAA](https://cdn.discordapp.com/attachments/287266770816073728/1277644911398883380/p4ya.png?ex=66cdeb0c&is=66cc998c&hm=62a3bded6f343980dd72f4d5f2d573a60ff4f27d80286c5c620d2d1eab94cbbc&)`);
    } else {
        console.error('no se pudo encontrar el canal de destino');
    }
});
...
client.on('messageCreate', (message) => {
    ...
    if (message.author.id === targetUserId) {
        ...
        if (random < 0.05) {
            console.log(random);
            message.reply('[TOMAAAAAAAAAAAAA](https://cdn.discordapp.com/attachments/1247185053017178162/1278703542793670738/Ae5060WhLO399Y_k.mp4?ex=66d5b979&is=66d467f9&hm=c004d5a96c0dd289c366f077072d49a5ba3fbcbdbc22d3d21bf9f1e72b2e6bf0&)');
        }
    }
});
...
client.on('messageCreate', (message) => {
	...
	if (random < 0.001) {
	  console.log(random)
	  message.reply('[esto deberia ser para alva pero no esta aqi](https://cdn.discordapp.com/attachments/1247185053017178162/1278703542793670738/Ae5060WhLO399Y_k.mp4?ex=66d5b979&is=66d467f9&hm=c004d5a96c0dd289c366f077072d49a5ba3fbcbdbc22d3d21bf9f1e72b2e6bf0&)');
	}
});
